...
// KocomojoSDK
#define COCOAPODS_POD_AVAILABLE_KocomojoSDK
#define COCOAPODS_VERSION_MAJOR_KocomojoSDK 0
#define COCOAPODS_VERSION_MINOR_KocomojoSDK 9
#define COCOAPODS_VERSION_PATCH_KocomojoSDK 0
